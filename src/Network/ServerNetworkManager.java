...
public class ServerNetworkManager {
    ...
    public void connectServer() throws IOException, ClassNotFoundException, SQLException {
        ...
        server.addUsuari(new Usuari("Jofre", 25, true, "jofre@minder.com", "jofre", "C"));
        server.addUsuari(new Usuari("Sara", 20, true, "sara@minder.com", "sara", "java"));
        server.addUsuari(new Usuari("Javo", 22, true, "javo@minder.com", "javo", "java" ));
        server.addUsuari(new Usuari("Manel", 22, true, "manel@minder.com", "manel", "C"));
        server.addUsuari(new Usuari("Marcel", 23, true, "marcel@minder.com", "marcel", "java"));
